...
common_essential() {
    ...
    pacman -S --needed --noconfirm base-devel sudo openssh gpm \
        iwd systemd-resolvconf zsh lsb-release git \
        xclip xsel wl-clipboard neovim python-neovim tmux networkmanager chezmoi
}
