...
[[ "${HAS_NVIDIA_CARD}" ]] && \
    GRAPHIC_PACKAGES=("nvidia" "nvidia-utils" "nvidia-settings" "libva-vdpau-driver")
...
pacman -S --needed --noconfirm lightdm lightdm-webkit2-greeter i3-gaps \
    polkit-gnome gnome-terminal xss-lock physlock i3lock-fancy-git \
    i3lock-color-git scrot wmctrl
